 ...
 */
@Component
public class ConsumerDeleted implements ChannelAwareMessageListener {
    ...
    public void onMessage(final Message message, final Channel channel) throws Exception {
        ...
        try {
            ...
            if (validateMessage(tag, invoiceMessage)) {
                if (invoiceMessage.getInvoice().getParent() == null) {
                    final int wsResult = webservice.sendInvoice(tag, invoiceMessage, true);
