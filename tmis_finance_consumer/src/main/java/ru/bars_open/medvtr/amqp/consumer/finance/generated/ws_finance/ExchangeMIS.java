 ...
 * 
 */
@WebServiceClient(name = "Exchange_MIS", targetNamespace = "http://schemas.xmlsoap.org/soap/envelope", wsdlLocation = "file:/home/dev/develop/tmis_mq_integrations/tmis_finance_consumer/src/main/resources/Exchange_MIS.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            ...
            url = new URL(baseUrl, "file:/home/dev/develop/tmis_mq_integrations/tmis_finance_consumer/src/main/resources/Exchange_MIS.wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'file:/home/dev/develop/tmis_mq_integrations/tmis_finance_consumer/src/main/resources/Exchange_MIS.wsdl', retrying as a local file");
