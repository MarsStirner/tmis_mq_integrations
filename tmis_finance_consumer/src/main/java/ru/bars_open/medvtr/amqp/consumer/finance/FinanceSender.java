...
public class FinanceSender {
    ...
    public int sendInvoice(final long messageTag, final Invoice invoice, boolean deleted, boolean refund) {
        ...
        final String parentInvoiceNumber = (refund && parent != null && parent.getInvoiceData() != null) ? parent.getInvoiceData().getNumber() : null;
        final int result = wsFactory.getWebService().putTreatment(
                event.getId(),
