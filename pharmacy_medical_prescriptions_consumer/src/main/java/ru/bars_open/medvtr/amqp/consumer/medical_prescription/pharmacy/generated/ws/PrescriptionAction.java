...
/**
 * <p>Java class for PrescriptionAction complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="PrescriptionAction">
 *   &lt;complexContent>
 ...
 *         &lt;element name="prescriptions" type="{http://schemas.xmlsoap.org/soap/envelope}MedicalPrescription" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "PrescriptionAction", propOrder = {
    "id",
    "status",
    "begDate",
    "endDate",
...
public class PrescriptionAction {
    ...
    @XmlElement(required = true)
    protected List<MedicalPrescription> prescriptions;
     ...
     * {@link MedicalPrescription }
     * 
     * 
     */
    public List<MedicalPrescription> getPrescriptions() {
        if (prescriptions == null) {
            prescriptions = new ArrayList<MedicalPrescription>();
        }
