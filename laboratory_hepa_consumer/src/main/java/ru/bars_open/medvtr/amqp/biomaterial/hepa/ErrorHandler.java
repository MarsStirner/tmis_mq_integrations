...
public class ErrorHandler implements org.springframework.util.ErrorHandler {
    ...
    public void handleError(final Throwable t) {
        ...
        } else if (exception instanceof NoSuchBiomaterialTypeException) {
            final NoSuchBiomaterialTypeException ex= (NoSuchBiomaterialTypeException) exception;
            responseSender.noSuchBiomaterialType(failedMessage, ex.getCode(), ex.getName());
