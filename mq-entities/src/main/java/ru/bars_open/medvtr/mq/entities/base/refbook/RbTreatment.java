...
public class RbTreatment implements Serializable
{
    ...
    private final static long serialVersionUID = 6967119992542041861L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RbTreatment) == false) {
            return false;
        }
        RbTreatment rhs = ((RbTreatment) other);
