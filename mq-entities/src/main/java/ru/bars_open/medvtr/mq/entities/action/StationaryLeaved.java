...
public class StationaryLeaved implements Serializable
{
    ...
    private StationaryLeaved.Status status;
    /**
     * Дата начала работы
     * 
     */
    ...
    private final static long serialVersionUID = 7417073872046723304L;
     ...
     */
    @JsonProperty("status")
    public StationaryLeaved.Status getStatus() {
        return status;
    }
     ...
     */
    @JsonProperty("status")
    public void setStatus(StationaryLeaved.Status status) {
        this.status = status;
    }
    ...
    public enum Status {
        ...
        private final static Map<String, StationaryLeaved.Status> CONSTANTS = new HashMap<String, StationaryLeaved.Status>();

        static {
            for (StationaryLeaved.Status c: values()) {
        ...
        @JsonCreator
        public static StationaryLeaved.Status fromValue(String value) {
            StationaryLeaved.Status constant = CONSTANTS.get(value);
            if (constant == null) {
