...
public class RlsPackaging implements Serializable
{
    ...
    private final static long serialVersionUID = -696236601903369451L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RlsPackaging) == false) {
            return false;
        }
        RlsPackaging rhs = ((RlsPackaging) other);
